...
public class NotificationUtils {
    ...
    private static final String NOTIFICATION_CHANNEL_ID = "com.mtsahakis.yolodetection.app";
    private static final String NOTIFICATION_CHANNEL_NAME = "com.mtsahakis.yolodetection.app";
